  ...
  return (
    <header className="sticky top-0 z-50 border-b border-black/5 bg-[#faf8f1]/88 backdrop-blur-xl">
      <nav className="mx-auto flex max-w-7xl items-center justify-between px-5 py-4 sm:px-8 lg:px-10">
        <a href="#top" aria-label="District Coffee home" data-magnetic="" className="group flex items-center gap-3 rounded-full outline-none transition duration-300 hover:scale-[1.02] focus-visible:ring-2 focus-visible:ring-[#1f6f49]/40">
        ...
        <div className="hidden items-center gap-8 md:flex">
          ...
          <a href="#testimonials" data-interactive="" className="rounded-full px-3 py-2 text-sm font-medium text-black/60 transition duration-300 hover:bg-white hover:text-[#17191f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1f6f49]/35">Ulasan</a>
          <a href="#about" data-interactive="" className="rounded-full px-3 py-2 text-sm font-medium text-black/60 transition duration-300 hover:bg-white hover:text-[#17191f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1f6f49]/35">Tentang Kami</a>
          <a href="#gallery" data-interactive="" className="rounded-full px-3 py-2 text-sm font-medium text-black/60 transition duration-300 hover:bg-white hover:text-[#17191f] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-[#1f6f49]/35">Galeri</a>
        </div>
