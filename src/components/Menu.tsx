...
export default function Menu() {
  return (
    <section id="menu" className="bg-[#e9eadf] px-5 py-20 sm:px-8 lg:px-10">
      <div className="mx-auto max-w-7xl">
        <div className="grid gap-8 lg:grid-cols-[0.85fr_1.15fr] lg:items-end">
          <div>
            <span data-reveal="" className="inline-flex rounded-full bg-[#995F2F] px-3 py-1 text-xs font-semibold text-white">Seduhan kami</span>
        ...
        <div className="mt-12 grid gap-5 sm:grid-cols-2 lg:grid-cols-4">
          <article data-card="" data-reveal="" className="group rounded-3xl bg-white/85 p-6 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] transition duration-500 hover:-translate-y-2 hover:bg-white" style={{ transformOrigin: "50% 50%" }}>
            <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#f0dfd1] text-[#995F2F] transition duration-500 group-hover:rotate-[-8deg] group-hover:scale-110">
          ...
          <article data-card="" data-reveal="" className="group rounded-3xl bg-white/85 p-6 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] transition duration-500 hover:-translate-y-2 hover:bg-white" style={{ transformOrigin: "50% 50%" }}>
            <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-[#f2e6dc] text-[#995F2F] transition duration-500 group-hover:rotate-[-8deg] group-hover:scale-110">
          ...
          <article data-card="" data-reveal="" className="group rounded-3xl bg-[#17191f] p-6 text-white shadow-[0_2.8px_2.2px_rgba(0,_0,_0,_0.034),_0_6.7px_5.3px_rgba(0,_0,_0,_0.048),_0_12.5px_10px_rgba(0,_0,_0,_0.06),_0_22.3px_17.9px_rgba(0,_0,_0,_0.072),_0_41.8px_33.4px_rgba(0,_0,_0,_0.086),_0_100px_80px_rgba(0,_0,_0,_0.12)] transition duration-500 hover:-translate-y-2" style={{ transformOrigin: "50% 50%" }}>
            <span className="flex h-12 w-12 items-center justify-center rounded-2xl bg-white/10 text-[#c7966e] transition duration-500 group-hover:rotate-[-8deg] group-hover:scale-110">
        ...
        <div data-reveal="" className="mt-10 grid gap-5 rounded-[2rem] bg-[#e8d5c4] p-5 lg:grid-cols-[1fr_0.8fr] lg:p-8">
          ...
          <div className="flex flex-col justify-between rounded-3xl bg-white p-6 shadow-[0px_2px_3px_-1px_rgba(0,0,0,0.1),0px_1px_0px_0px_rgba(25,28,33,0.02),0px_0px_0px_1px_rgba(25,28,33,0.08)]">
            <div className="">
              <p className="text-xs font-semibold uppercase tracking-[0.18em] text-[#995F2F]">Favorit hari ini</p>
            ...
            <div className="mt-8 flex flex-wrap gap-2">
              <span className="rounded-full bg-[#f2e6dc] px-4 py-2 text-sm font-medium text-black/65">ramah susu oat</span>
              <span className="rounded-full bg-[#f2e6dc] px-4 py-2 text-sm font-medium text-black/65">edisi terbatas</span>
              <span className="rounded-full bg-[#f2e6dc] px-4 py-2 text-sm font-medium text-black/65">disajikan dingin</span>
            </div>
          </div>
        </div>
      </div>
