        ...
        <div className="rounded-[2rem] bg-[#1e211f] p-6 shadow-[0px_0px_0px_1px_rgba(0,0,0,0.06),0px_1px_1px_-0.5px_rgba(0,0,0,0.06),0px_3px_3px_-1.5px_rgba(0,0,0,0.06),_0px_6px_6px_-3px_rgba(0,0,0,0.06),0px_12px_12px_-6px_rgba(0,0,0,0.06),0px_24px_24px_-12px_rgba(0,0,0,0.06)] lg:p-8">
          <div className="grid gap-10 lg:grid-cols-[1.25fr_0.75fr_0.75fr_1fr]">
            <div>
              <a href="#top" data-magnetic="" className="inline-flex items-center gap-3 rounded-full outline-none transition duration-300 hover:scale-[1.02] focus-visible:ring-2 focus-visible:ring-white/30">
                <span className="flex h-9 w-9 items-center justify-center rounded-xl bg-white text-[#17191f]">
                  <span className="text-sm font-semibold tracking-[-0.08em]">DC</span>
                </span>
              ...
              <p className="mt-5 max-w-sm text-sm leading-6 text-white/55">
                42 Greenway Lane, Portland · Buka setiap hari dari pukul 07:00 hingga 18:00.
              </p>
            </div>
            ...
            <div>
              ...
              <ul className="mt-4 space-y-3 text-sm text-white/55">
                <li>Senin—Jumat · 07:00—18:00</li>
                <li>Sabtu · 08:00—18:00</li>
                <li>Minggu · 08:00—16:00</li>
                <li>Dapur tutup pukul 15:00</li>
              </ul>
            </div>
            ...
            <div>
              ...
              <form className="mt-5 flex gap-2" onSubmit={(e) => e.preventDefault()}>
                ...
                <input id="email" type="email" placeholder="Alamat email" className="min-w-0 flex-1 rounded-xl border border-white/10 bg-white/10 px-4 py-3 text-sm text-white outline-none transition duration-300 placeholder:text-white/35 focus:border-[#b9d9ab]/60 focus:bg-white/15 focus:ring-2 focus:ring-[#b9d9ab]/15" />
                <button data-magnetic="" type="submit" className="rounded-xl bg-white px-4 py-3 text-sm font-semibold text-[#17191f] transition duration-300 hover:-translate-y-0.5 hover:bg-[#dce5d6] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/35">Gabung</button>
              </form>
            </div>
          </div>

          <div className="mt-10 flex flex-col justify-between gap-4 border-t border-white/10 pt-6 text-sm text-white/42 sm:flex-row">
            <p>Hak Cipta © 2028 District Coffee</p>
            <div className="flex flex-wrap gap-5">
              <a data-interactive="" href="#" className="transition duration-300 hover:text-white">Instagram</a>
              <a data-interactive="" href="#" className="transition duration-300 hover:text-white">Privasi</a>
              <a data-interactive="" href="#" className="transition duration-300 hover:text-white">Aksesibilitas</a>
            </div>
          </div>
        </div>
      </div>
